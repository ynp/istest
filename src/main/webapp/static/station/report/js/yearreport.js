...
$(function() {
	...
	$("#export").click(function() {
		...
		var farmid = $("#farmid").val();//电场ID
		var powertype = $("#powertype").val();//预测类型
		location.href = getWebRootUrl()+"/yearReport/exportYearReport?farmid=" + farmid + "&powertype=" + powertype + "&starttime=" + starttime + "&endtime=" + endtime;
	});
});
//初始化查询数据
